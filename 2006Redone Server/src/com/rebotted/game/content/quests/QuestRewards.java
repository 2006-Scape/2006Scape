...
public class QuestRewards {
	...
	public static void QuestReward(Client client, String questName, String Line1, String Line2, String Line3, String Line4, String Line5, String Line6, int itemID) {
		client.getPacketSender().sendFrame126("You have completed " + questName + "!", 12144);
		client.getPacketSender().sendFrame126("" + client.questPoints, 12147);
		client.getPacketSender().sendFrame126(Line1, 12150);
		client.getPacketSender().sendFrame126(Line2, 12151);
		client.getPacketSender().sendFrame126(Line3, 12152);
		client.getPacketSender().sendFrame126(Line4, 12153);
		client.getPacketSender().sendFrame126(Line5, 12154);
		client.getPacketSender().sendFrame126(Line6, 12155);
		if (itemID > 0) {
			client.getPacketSender().sendFrame246(12145, 250, itemID);
		}
		client.getPacketSender().showInterface(12140);
		client.getPacketSender().sendMessage("You completed " + questName + "!");
		QuestAssistant.sendStages(client);
		client.getPacketSender().sendQuickSong(93, 0);
	}
	...
	public static void knightsReward(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7346);
	...
	public static void gertFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7360);
	...
	public static void pirateFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7341);
	...
	public static void julietFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7343);
	...
	public static void vampFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7347);
	...
	public static void runeFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7335);
	...
	public static void sheepFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7344);
	...
	public static void doricFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7336);
	...
	public static void impFinish(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7340);
	...
	public static void cookReward(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7333);
	...
	public static void blackKnightReward(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7332);
	...
	public static void shieldArravReward(Client client) {
		...
		client.getPacketSender().sendFrame126("@gre@" + QUEST_NAME + "", 7345);
