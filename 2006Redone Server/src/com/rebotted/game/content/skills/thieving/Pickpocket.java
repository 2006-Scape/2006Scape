...
public class Pickpocket extends SkillHandler {
	...
	public static enum npcData {
		...
		MAN(new int[] { 1, 2, 3, 3222 }, 1, 8.0, 1, 5, new int[] { 995, 3 }),
		WOMEN(new int[] { 4, 5, 6 }, 1, 8.0, 1, 5, new int[] { 995, 3 }),
		FARMER(new int[] { 7, 1757 }, 10, 14.5, 1, 5, new int[] { 995, 9 }, new int[] { 5318, 4 }),
		HAM_FEMALE(new int[] { 1715 }, 15, 18.5, 2, 4, new int[] { 995, 2 + r(19) },
				new int[] { 4302, 1 }, new int[] { 4304, 1 }, new int[] { 4298,
						1 }, new int[] { 4308, 1 }, new int[] { 4300, 1 },
				new int[] { 4310, 1 }, new int[] { 4306, 1 }),
		HAM_MALE(
				...
				new int[] { 4308, 1 }, new int[] { 4300, 1 }, new int[] { 4310,
						1 }, new int[] { 4306, 1 }),
		WARRIOR(new int[] { 15, 18 }, 25, 26.0, 2, 5, new int[] { 995, 18 }),
		ROGUE(new int[] { 187 }, 32, 35.5, 2, 5, new int[] { 995, 25 },
		...
		MASTER_FARMER(new int[] { 2234, 2235 }, 38, 43.0, 2, 5, new int[][] {
				{ i("potato seed"), 1 + r(2) },
				{ i("onion seed"), 1 + r(2) },
				{ i("cabbage seed"), 1 + r(2) },
				{ i("tomato seed"), 1 + r(1) },
				{ i("sweetcorn seedseed"), 1 + r(1) },
				{ i("strawberry seed"), 1 },
				{ i("watermelon seed"), 1 },
				{ i("barely seed"), 1 + r(3) },
				{ i("hammerstone seed"), 1 + r(2) },
				{ i("asgarnian seed"), 1 + r(1) },
				{ i("jute seed"), 1 + r(2) },
				{ i("yanillian seed"), 1 + r(1) },
				{ i("krandorian seed"), 1 },
				{ i("wildblood seed"), 1 },
				{ i("redberry seed"), 1 },
