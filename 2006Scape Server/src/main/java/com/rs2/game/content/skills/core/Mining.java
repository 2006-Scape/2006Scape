...
public class Mining {
    ...
    public void obtainGem(Player player) {
        ...
        player.getPacketSender().sendMessage("You found an " + Deprecated.getItemName(reward) + ".");
    }
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (player.isMining) {
                    if (!giveGem(player)) {
                        ...
                        player.getPacketSender().sendMessage("You manage to mine some " + Deprecated.getItemName(oreID).toLowerCase() + ".");
                    } else {
                        obtainGem(player);
                    }
                }
